...
wood = np.asarray([0.15, 0.32, 0.36, 0.21, 0.39, 0.27])
wool = np.asarray([0.10, 0.25, 0.52, 0.48, 0.60, 0.64])
x = np.linspace(1, 6, 6)
...
plt.plot(x, wood, '-o', color='firebrick', linewidth=0.7, label=r'木纹穿孔板', markersize=4)
